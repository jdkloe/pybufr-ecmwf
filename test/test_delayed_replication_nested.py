...
test nested delayed replication encoding and decoding
'''
...
for subset in range(num_subsets):
    ...
    values[i] = num_replications1[subset]
    i = i+1
    repl_counts.append(num_replications1[subset])

    for j in range(num_replications1[subset]):
